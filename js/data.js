...
const PORTFOLIO = {
  ...
  projects: [
  {
    id: "vyora",
    title: "Vyora",
    subtitle: "Business Lead Automation Platform",
    tech: ["React", "Node.js", "Express.js", "MongoDB"],
    flow: ["Business", "Lead Capture", "Automation", "Backend", "Database"],
    points: [
      "Built a full-stack business lead automation platform with separate frontend and backend applications.",
      "Implemented business-focused lead management and automation workflows to streamline lead handling.",
      "Integrated MongoDB Atlas as the cloud database for application data management.",
      "Deployed the frontend on Vercel and the backend on Render for a production-ready full-stack application.",
    ],
    live: "https://vyora-business-lead-automation.vercel.app/",
    github: "https://github.com/nikhilmaharana/Vyora---Business-Lead-Automation",
  },
  {
    id: "gossiphy",
    title: "Gossiphy",
